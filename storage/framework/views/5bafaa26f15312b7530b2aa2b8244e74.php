    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            form.addEventListener('submit', async (e) => {
                ...
                try {
                    const response = await fetch("<?php echo e(route('speak')); ?>", {
                        method: 'POST',
...
<?php /**PATH C:\Users\silva\OneDrive\Desktop\Desafio_PHP\desafio_estagio\resources\views/main.blade.php ENDPATH**/ ?>